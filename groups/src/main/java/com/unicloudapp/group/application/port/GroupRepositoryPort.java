...
public interface GroupRepositoryPort {
    ...
    boolean existsByNameAndSemester(GroupName name, Semester semester);

    Page<@NotNull GroupRowProjection> findAllByCriteria(GroupFilterCriteria criteria, Pageable pageable);

    Page<@NotNull GroupRowProjection> findAllByCriteriaAndContainsCloudResourceAccess(
